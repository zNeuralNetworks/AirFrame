    ...
    <div className="af-page">
      ...
      <div className="af-page-header">
        <div className="flex items-center gap-5">
          <div className="bg-corgi-500/10 p-3 rounded-2xl border border-corgi-500/20 apple-shadow">
        ...
        <div className="flex items-center gap-4">
          <div className="flex flex-col items-end">
            <div className="flex items-center gap-2 mb-1">
              <span className="af-meta text-brand-500">Level {user.level}</span>
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2.5 px-5 py-3 bg-surface text-apple-orange rounded-full font-semibold apple-shadow border border-border">
                <Flame className="w-5 h-5 fill-apple-orange text-apple-orange stroke-[2.5]" />
                <span className="text-sm">{user.streakDays} Day Streak</span>
              </div>
              <div className="flex items-center gap-2.5 px-5 py-3 bg-surface text-brand-500 rounded-full font-semibold apple-shadow border border-border">
                <Zap className="w-5 h-5 fill-brand-500 text-brand-500 stroke-[2.5]" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="lg:col-span-3 af-card flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <span className="af-eyebrow text-brand-500">Current Mission</span>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex justify-between items-end">
                <span className="af-meta">Overall Progress</span>
                <span className="text-2xl font-bold text-brand-500">{progressPercent}%</span>
              </div>
            ...
            <button onClick={onContinue} className="af-primary-action">
        ...
        {/* Skill Radar */}
        <div className="lg:col-span-2 af-card-compact flex flex-col">
            <h4 className="af-eyebrow mb-4 self-start">Mastery Goal</h4>
            ...
            <div className="w-full pt-4 border-t border-border mt-4 flex items-center justify-between text-xs font-semibold">
               <span className="af-meta">Rank</span>
               <span className="text-brand-500 font-bold uppercase">{getRank(user.level)}</span>
            </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-slate-900 rounded-apple p-8 apple-shadow-lg border border-white/5 relative overflow-hidden flex flex-col justify-between group">
          ...
          <div className="relative z-10">
            <div className="flex items-center gap-2 mb-8 text-brand-400">
              ...
              <span className="af-meta text-brand-400">{featuredInsight.context}</span>
            </div>
            <div className="space-y-4 mb-8">
              <h4 className="text-2xl font-bold text-white">{featuredInsight.title}</h4>
              <p className="text-white/70 text-base leading-7 italic">
                "{featuredInsight.text}"
              </p>
            </div>
          </div>
          <div className="relative z-10 pt-8 border-t border-white/10">
            <div className="af-meta text-white/40 mb-1">Knowledge Source</div>
        ...
        <div className="af-card flex flex-col justify-between">
            <div className="space-y-6">
                <div className="flex items-center gap-3">
                   <div className="p-2 bg-brand-50 rounded-lg text-brand-500">
                      <BrainCircuit className="w-5 h-5" />
                   </div>
                   <h4 className="af-eyebrow">Glossary</h4>
                </div>
                <div className="space-y-2">
                    <h5 className="af-card-title text-2xl">{featuredGlossary.term}</h5>
                    <p className="af-body-sm line-clamp-3">
                        {featuredGlossary.definition}
                    </p>
                </div>
                <div className="p-5 bg-apple-orange/10 border border-apple-orange/20 rounded-2xl">
                    <div className="flex items-center gap-2 text-apple-orange af-meta mb-1.5">
                        <Info className="w-3.5 h-3.5" /> Misconception
                    </div>
                    <p className="text-sm text-apple-orange font-semibold leading-6">
                        "{featuredGlossary.misconception}"
                    </p>
                </div>
            </div>
            <div className="pt-6 mt-4 border-t border-border">
                <button className="text-brand-600 font-semibold text-sm flex items-center gap-2 hover:gap-3 transition-all group">
        ...
        <div className="af-card flex flex-col justify-between">
            <div className="space-y-8">
                <div className="flex items-center gap-3">
                   ...
                   <h4 className="af-eyebrow">Protocol Snapshot</h4>
                </div>
                <div>
                   <span className="af-meta opacity-70 mb-4 block">Metric: {protocolSnapshot.metric}</span>
                   <div className="space-y-6">
                      <div className="flex items-center justify-between p-4 bg-app rounded-2xl border border-border">
                         <span className="font-semibold text-text-muted">Wi-Fi 6</span>
                      ...
                      <div className="flex items-center justify-between p-4 bg-brand-500 text-white rounded-2xl apple-shadow shadow-brand-500/20">
                         <span className="font-semibold opacity-80">Wi-Fi 7</span>
            ...
            <div className="pt-6 mt-4 border-t border-border">
                <div className="af-meta text-brand-600 mt-auto">Certified Tech Stack</div>
            </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          {user.quizHistory.length > 0 ? (
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {user.quizHistory.slice(-4).reverse().map((attempt, idx) => {
                ...
                return (
                  <div key={idx} className="af-card-compact flex flex-col justify-between group hover:scale-[1.02] transition-all">
                    <div>
                      <div className="flex justify-between items-start mb-4">
                        <span className="af-meta opacity-70">Quiz Result</span>
                      ...
                      <h4 className="af-card-title line-clamp-2 mb-2">{lesson?.title || 'Unknown Lesson'}</h4>
                    </div>
            ...
            <div className="bg-surface-highlight border-2 border-dashed border-border rounded-apple p-10 text-center text-text-tertiary">
              <BookOpen className="w-12 h-12 mx-auto mb-4 opacity-20" />
              <p className="font-medium text-base">No sessions recorded yet.</p>
              <button 
                onClick={onContinue}
                className="text-brand-500 font-semibold mt-2 hover:underline"
              >
        ...
        <section className="space-y-6">
          ...
          <div className="af-card h-full min-h-[300px]">
            {user.achievements.length > 0 ? (
                ...
                {user.achievements.slice(0, 4).map((achievement) => {
                  ...
                  return (
                    <div key={achievement.id} className="flex items-center gap-4 p-4 rounded-3xl bg-app border border-border group hover:bg-surface-highlight hover:apple-shadow transition-all duration-300">
                      ...
                      <div>
                        <div className="font-semibold text-text-primary">{achievement.title}</div>
              ...
              <div className="flex flex-col items-center justify-center h-full text-text-muted space-y-4 opacity-40">
                ...
                <p className="font-semibold">No achievements yet. Keep learning!</p>
              </div>
            )}
          </div>
        </section>
