...
const HeroPage: React.FC<HeroPageProps> = ({ onEnter }) => {
  ...
  return (
    <div data-galen-page="landing" className="force-light min-h-screen bg-[#F2F2F7] selection:bg-brand-500/30 selection:text-brand-900 font-sans text-text-primary overflow-x-hidden">
