  ...
  return (
    <div className="min-h-screen bg-app flex flex-col items-center p-6 font-sans relative overflow-y-auto">
      ...
      <div className="max-w-5xl w-full relative z-10 my-12">
        ...
        {/* Action Cards */}
        <div className={`grid grid-cols-1 ${isAdmin ? 'md:grid-cols-2' : ''} gap-6 mb-24 max-w-lg mx-auto md:max-w-none`}>
          {/* Airframe Labs Card */}
          <button 
          ...
          {isAdmin && (
            ...
            >
              <div className="mb-6 p-4 bg-app rounded-2xl w-fit group-hover:bg-slate-500 transition-colors">
              ...
              <div className="flex items-center gap-2 text-text-muted font-bold text-xs uppercase tracking-wider group-hover:gap-3 transition-all">
