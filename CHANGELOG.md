...
- Fixed Cloud Build shell variable escaping for generated service-account names.
- Changed production start to run bundled JavaScript from `dist-server/server.js` instead of executing `server.ts` through `tsx`.
